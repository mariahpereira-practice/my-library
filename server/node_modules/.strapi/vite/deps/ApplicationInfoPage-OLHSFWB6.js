...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-LF3YKUY6.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-HC3NB5TG.js")).AIUsage, {
    enabled: isAiEnabled
  });
...
//# sourceMappingURL=ApplicationInfoPage-OLHSFWB6.js.map
